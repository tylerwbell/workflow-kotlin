...
public open class SimpleLoggingWorkflowInterceptor : WorkflowInterceptor {
  ...
  private inner class SimpleLoggingContextInterceptor<P, S, O>(
    ...
    override suspend fun onSideEffectRunning(
      ...
      // Note that because logMethod is inline, it automatically acts like a suspend function here.
      // The START will be logged immediately, and the END will be logged when the side effect
